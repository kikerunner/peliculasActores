...
<body>
<form action="cargarListadoByPerson" method="post">
	<input type="text" id="nombreAbuscar" name="nombreAbuscar" required placeholder="Introduce un nombre para buscar">
	<input type="submit" value="ver listado">
</form>


<%
List<Owner> owners = (List<Owner>)request.getAttribute("listAllOwnersByName");
 pageContext.setAttribute("owner", owners);
%>
<br/>
<br/>
<br/>
...
<table border="1">
	...
	<tbody>
		<c:forEach var="owner1" items="${listAllOwnersByName}">
			<tr>
